    ...
    return (
        <Wrapper style={{ background: "url('./pictures/authpageBackground.png')", backgroundSize: "80% 1%" }}>
            <div class="w-12/12 max-w-lg px-2 pricingCard py-8 mx-auto my-32 rounded-xl">
                <h3 class="text-center">Login to your <span className="text-qosblue"> QOS </span> account</h3>
                <form class="">
                    ...
                    <button class="btn w-11/12 h-12 btn-primary btn-sm md:max-w-sm mx-auto mt-10 block">
                        Log In
                    </button>
                </form>
            </div>
