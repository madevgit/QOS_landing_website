...
export default function LandingSection() {
    return (<Wrapper childrenClassName="md:flex pt-5 flex-row-reverse relative" id="Landing" className="pb-10 md:pb-20 z-10 overflow-hidden relative">
        ...
        <div>
            ...
            <div className="mt-6 md:mt-10">
                <Link to="/register" className="p-2 inline-block rounded-full px-3 bg-opacity-90 shadow-lg bg-gradient-to-bl from-qosorange to-qosblue text-qosgray text-opacity-70 font-medium btn-sm max-w-max mx-auto m-2">
                    Create Account
                </Link>
