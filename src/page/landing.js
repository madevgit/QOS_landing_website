...
export default function LandingPage() {
    return (
        <main className="relative">
            ...
            <Wrapper className="py-5 md:py-10 overflow-auto hideScroll bg-qosgray bg-opacity-75">
                <div className="min-w-max mx-auto">
                    {[...PartnersLogo, ...PartnersLogo].map((Partner, Index) => <img className="inline-block h-12 md:h-14 mx-4 " src={Partner} alt="hello part" />)}
                </div>
            </Wrapper>
